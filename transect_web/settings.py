"""
Django settings for transect_web project.
...
ROOT_URLCONF = "transect_web.urls"
...
WSGI_APPLICATION = "transect_web.wsgi.application"
...
# lets not change this, otherwise it will break the database
